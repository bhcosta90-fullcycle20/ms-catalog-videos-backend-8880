...
{
    public function testCategoryIdField()
    {
        $rule = new GenresHasCategoriesRule([1, 2, 2]);
    ...
    {
        /** @var $ret Mockery */
        $ret = Mockery::mock(GenresHasCategoriesRule::class, [$categoriesId]);

        return $ret->makePartial()
